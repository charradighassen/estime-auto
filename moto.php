...
<head>
  ...
  <link rel="stylesheet" id="icomoon-css-css" href="./assets/css/icomoon.css" type="text/css" media="all" />
            ...
            <div class="menu-turbo-menu-container">
              <ul id="menu-turbo-menu" class="nav navbar-nav navbar-center menu">
                ...
                <li id="menu-item-1156" class="menu-item menu-item-type-post_type menu-item-object-page dropdown">
                  <a href="./propos.html" class="main-link  dropdown-toggle" role="button" data-toggle=""
                ...
                <li id="menu-item-1157" class="menu-item menu-item-type-post_type menu-item-object-page dropdown">
                  <a href="./contact.php" class=" main-link  dropdown-toggle" role="button" data-toggle=""
                      ...
                      <form action="./scripts/moto_form.php" method="POST" class="form form-group">
                        <div class="form-elements">
                          <div class="col col-md-6 form-element">
                            ...
                            <label for="" class="select">
                              <select required name="type" id="modele" class="select-element">
                                ...
                                <option value="enduros">enduros</option>
                                <option value="trial">trial</option>
                                <option value="roadsters">roadsters</option>
                                <option value="routières">routières</option>
                                <option value="Néo-Rétro">Néo-Rétro</option>
                          ...
                          <div class="col col-md-6 form-element">
                            ...
                            <label for="" class="select">
                              <select required name="marque" id="marque" class="select-element">
                                ...
                                <option value="Blasi" > Blasi</option>
                                ...
                                <option value="Eccho" > Eccho</option>
                                ...
                                <option value="Guoben" > Guoben</option>
                                ...
                                <option value="Jikov" > Jikov</option>
                                ...
                                <option value="Korado" > Korado</option>
                                ...
                                <option value="Magpower" > Magpower</option>
                                ...
                                <option value="Mujoo" > Mujoo</option>
                                ...
                                <option value="Sidecarbrand" > Sidecarbrand</option>
                                <option value="_ads4" > _ads4</option>
                                ...
                                <option value="Ural/irbit" > Ural/irbit</option>
                                ...
                                <option value="Zpmoto" > Zpmoto</option>
                        ...
                        <div class="form-elements">
                          ...
                          <div class="col col-md-6 form-element">
                            ...
                            <input required type="text" class="input" placeholder="Tapez votre modéle"
                              name="modele">
                        ...
                        <div class="form-elements">
                          <div class="col col-md-6 form-element">
                            <input type="submit" name="suivant" id="applyFilter" class="  form-button "
                              value="Suivant" />
